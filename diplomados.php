...
<head>
    ...
    <?php 
                $query1= "SELECT idtipo, descripcion FROM tipo_clases WHERE idtipo=3 ORDER BY 1";
                ...
                while($datos2= pg_fetch_row($respuesta2)){
                    $descripcion2 .= "<tr><td title='".$datos2[0]."'>".$datos2[0]."</td>    <td title='".$datos2[1]."'>".$datos2[1]."</td> <hr size='2' color=#000000 width='850'/></tr>";
                }
    ?>
    <div id="Contenido">
    <section>
        ...
        ¿Qué conforma nuestros diplomados?
        </td></tr>
